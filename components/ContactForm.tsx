...
const ContactForm = () => {
  ...
  return (
    ...
    >
      ...
      {/* If sending, change button to sending */}
      {sendingStatus ? (
        <button
          disabled
          type='button'
          className='text-white bg-[#007a3b] hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-green-900 focus:border-green-900 font-medium rounded-lg text-sm w-full px-5 py-2.5 inline-flex justify-center items-center text-center'
        >
          <svg
            aria-hidden='true'
            role='status'
        ...
        <button
          type='submit'
          className='text-white bg-[#007a3b] hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-green-900 focus:border-green-900 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center'
        >
          Send
        </button>
      )}
